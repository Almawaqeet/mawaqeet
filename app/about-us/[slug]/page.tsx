        ...
        <MbisProvider>
            ...
            <section className='max-w-[2000px] m-auto bg-personality xmd:pt-16 lg:pt-0'>
                <main className=' md:pt-0 relative lg:h-screen'>
                    <div key={teamMember.id} className={`xmd:grid lg:grid-cols-[1fr_1fr] xmd:grid-rows-1 items-center lg:gap-16 lg:justify-between  xmd:h-[448px] md:h-[420px]  ${whiteSpaces.paddingX} `}>
