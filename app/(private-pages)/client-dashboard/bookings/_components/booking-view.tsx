...
import { CrownIcon, StarIcon, DiamondIcon, CalendarIcon, DollarSignIcon, ClockIcon, PackageIcon, CreditCardIcon, PercentIcon, XIcon } from 'lucide-react';
        ...
        <div className="grid gap-4 sm:gap-8 md:grid-cols-3">
            ...
            <CardContent className="p-4 sm:p-6">
                ...
                <p className="text-lg font-semibold text-gray-900">
                    ₦{booking?.balance ? Number(booking.balance).toLocaleString('en-NG', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : 'N/A'}
                </p>
            ...
            <CardContent className="grid md:grid-cols-3 gap-4 sm:gap-6 p-4 sm:p-6">
                ...
                <div className="md:col-span-3 flex gap-4">
                    <Button className="flex-1 bg-brand-color" onClick={() => router.push(CLIENT_ROUTES.PrivatePages.clientDashboard.booking.initiatePayment(booking?.id as string))}>
