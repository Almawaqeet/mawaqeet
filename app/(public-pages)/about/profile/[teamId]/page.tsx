...
export default function TeamMemberPage({ params }: { params: { teamId: string } }) {
...
export async function generateMetadata({ params }: { params: { teamId: string } }): Promise<Metadata> {
    ...
    const description = teamMember?.personality ?? 'Meet our dedicated team member at Al-Mawaqeet Travels, committed to providing exceptional Hajj and Umrah services.';
