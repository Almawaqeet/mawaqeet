        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <Link href="https://www.mofa.gov.sa/" target="_blank">
              ...
              />
              <div>
                <h3 className="text-xl font-semibold text-white text-left mt-2">Saudi Foreign Affairs</h3>
                <p className="text-gray-300 mt-1 text-left">Official Government Partner</p>
              </div>
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <Link href="https://www.iata.org/" target="_blank">
              ...
              />
              <div>
                <h3 className="text-xl font-semibold text-white text-left mt-2">IATA</h3>
                <p className="text-gray-300 mt-1 text-left">International Air Transport Association</p>
              </div>
              </Link>
            </div>
          </div>
