...
const Purpose: React.FC<PurposeProps> = ({
  ...
  return (
    <div className="border-[0.5px] xmd:py-3 rounded-[8px] xmd:px-5 border-[hsla(0, 0%, 20%, 0.25)] md:py-6 lg:py-16 transition-all duration-[0.5s] ease-[cubic-bezier(0.645,0.045,0.355,1)] delay-[400] cursor-pointer hover:bg-hover-color group">
