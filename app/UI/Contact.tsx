      ...
      <div className={` ${whiteSpaces.paddingX} ${whiteSpaces.paddingY}`}>
        {contact.map((heading) => (
          <Headings
            ...
            type={'sectionName'}
            classname={`md:leading-10 xmd:leading-6 xmd:text-center text-white xmd:mb-6 font-dejavu`}
          >
          ...
          >
            <div className="flex xmd:gap-1 md:gap-4 justify-between ">
              ...
              <div className="flex flex-col w-fit xmd:gap-3 ">
                <label className="font-semibold xmd:xmd:text-end mobile:text-fz-sm xmd:text-fz-xss leading-8 tracking-[0.81px] text-[#333333] font-dejavu">
                  Email Address
                </label>
                <BtnGlobal
                  className={`${btnColor} rounded-lg xmd:px-2 sm:px-4 `}
                >
                  <h6 className="font-normal xmd:text-fz-xss leading-8 tracking-[0.14px] text-center font-dejavu">
            ...
            <div className="flex xmd:gap-0 justify-between items-center">
              <div
                className={`${bgRound} rounded-full mobile:h-[50px] mobile:w-[50px] xmd:w-[50px] xmd:h-[50px] lg:w-[100px] lg:h-[100px] relative flex items-center md:w-[70px] md:h-[70px] xmd:bottom-7 mobile:bottom-0`}
                >
            ...
            <div className="flex  xmd:gap-2 flex-row-reverse justify-between bg-[#F9F9F9] mobile:p-10 xmd:px-4 xmd:py-4 md:p-8 rounded-lg rounded-b-none live-chat relative xmd:pb-[16px] mobile:pb-[24px] sm:pb-[32px] md:pb-[40px] lg:pb-[48px]">
              ...
              <div className="flex flex-col xmd:gap-2 xmd:pb-4 sm:pb-0">
                ...
                <p className="font-normal xmd:text-fz-xxs mobile:text-fz-xsm sm:text-fz-xss tracking-[0.16px] text-center text-[#333333] font-dejavu">
                  Message our virtual assistant
                </p>
                <BtnGlobal className={`${btnColor} rounded-lg xmd:px-4 `}>
                  <h6
                    className={`font-normal xmd:text-fz-xss leading-8 tracking-[0.14px] text-center text-white ${textColor} font-dejavu`}
                  >
                    Message Us
                  </h6>
                </BtnGlobal>
