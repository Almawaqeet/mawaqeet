    ...
    highlights: [
      {
        ...
        note: 'Delve into the significant historical and religious sites within Makkah and Madinah.',
        image: ziyarah,
      },
      {
        id: 'Intensive',
        highlight: 'Intensive Pre-departure Seminars',
        note: 'Acquire essential knowledge and insights to adequately prepare for your Hajj or Umrah.',
        image: preparation,
      },
      {
        id: 'Special',
        highlight: 'Special Dietary Scheme',
        note: 'Catering to specific dietary requirements, especially local and continental cuisine that may be difficult to find within the sphere of Haram, we guarantee a pilgrimage journey that is comfortable for everyone.',
        image: culture,
      },
    ],
  },
    ...
    highlights: [
      {
        ...
        note: 'Visit distinguished universities such as Islamic University of Madeenah in Saudi Arabia, Islam University of Kuwait, Hamad Bin Khalifa University in Qatar, Universiti Brunei Darussalam in Brunei, and University of Bahrain in Bahrain.',
        image: university,
      },
      {
        id: 'interact',
        highlight: 'Interact with Faculty and Admission Officers',
        note: 'Benefit from insightful discussions on academic programs, the application process, and the daily life of a student through interactions with professors and admissions officers.',
        image: admission,
      },
      {
        id: 'Engage',
        highlight: 'Engage with the Local Culture',
        note: 'Discover the essence of the region’s culture through its vibrant cities, historical monuments, and cultural artifacts, enriching your understanding of its profound heritage.',
        image: appsupport,
      },
    ],
  },
