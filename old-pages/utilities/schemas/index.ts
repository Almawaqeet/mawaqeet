...
export const verifyPasswordSchema = Yup.object().shape({
  password: Yup.string()
    ...
    .matches(passwordRules, {
      message:
        'Password must contain atleast 1 upper case, 1 lower case, 1 numeric digit',
    })
    .required('Input generated password'),
...
export const onboardingSchema = Yup.object().shape({
  ...
  address: Yup.string()
    .min(3, 'Residential adsress is too short')
    .max(200, 'Residential is address too long')
