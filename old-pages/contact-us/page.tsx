...
const ContactUs: React.FC = () => {
  return (
    <MbisProvider>
      ...
      <section className=" max-w-[2000px]  m-auto relative lg:pb-96 md:pb-[40rem] sm:pb-[46rem] xmd:pb-[50rem]">
        <main className="bg-personality bg-contain bg-blend-normal  md:pb-0">
          <main className="  h-screen m-auto flex items-center justify-center flex-col ">
            <Headings
              type="heroHeading"
              classname="text-white  xmd:pb-3 text-center"
            >
              Contact Us
            </Headings>
            <Headings type="heading_1" classname="text-white text-center">
              Contact us using any of the medium below
            </Headings>
          </main>
        </main>
      ...
      <footer
        className={`${whiteSpaces.sectionMargin} md:pt-6 xmd:pt-12 relative`}
      >
        <Footer />
      </footer>
    </MbisProvider>
