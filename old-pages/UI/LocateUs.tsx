...
const LocateUs = () => {
  return (
    <section className={`max-w-[2000px] m-auto flex flex-col`}>
      <main
        className={` grid md:grid-cols-[1fr_minmax(10px,_20px)_1fr] xmd:grid-cols-1 xmd:gap-8 md:gap-2 lg:gap-8  xmd:px-5 px-[20px] sm:px-[16px] md:px-12 lg:px-[150px] xl:px-[150px] 2xl:px-[150px] ${whiteSpaces.sectionMargin}`}
      >
        <div
        ...
        >
          <div className="flex flex-col xmd:gap-2 md:gap-8 xmd:pb-4 sm:pb-0">
            <div className="flex justify-between items-center">
              ...
              >
                <IoLocationOutline
                  className="text-hover-color absolute left-1/2 transform -translate-x-1/2 top-1/4 xmd:w-[19.2px] xmd:h-[19.2px]
                                sm:w-[24px]
                                sm:h-[24px]
            ...
            <p className="font-normal xmd:text-fz-xss xmd:leading-6 xmd:tracking-tight mobile:text-fz-xsm md:text-fz-sm md:leading-8 md:tracking-[0.18px] text-justify text-[#333333]   ">
              MAKTABAT DAARILHADITH SHOP NO 20/21 KOLEOSO PLAZA, KOLAWOLE AREA,
              SAKI USTADH YUUSUF MURTADAH AL-MUJAHIDUN
            </p>
            <div>
              <BtnGlobal
      ...
      <footer
        className={`${whiteSpaces.sectionMargin} xmd:pt-6 sm:pt-16 md:pt-0`}
      >
        <Footer />
      </footer>
    </section>
