  ...
  return (
    <>
      <section className="max-w-[2000px] m-auto relative">
        <div
          className={` xmd:px-5 px-[20px] sm:px-[16px] md:px-12 lg:px-[150px] xl:px-[150px] 2xl:px-[150px] xmd:pb-[87px] md:pb-[145px]`}
        >
          <div
            className={`bg-[#F8F8F8] drop-shadow-transparent shadow-lg xmd:px-5  `}
          >
            <main className="xmd:pt-[17px] md:pt-[58px] ">
                ...
                <div key={index} className="">
                  ...
                  >
                    {index === 1 ? (
                      ...
                      <span
                        key={`${index}-copy`}
                        className="flex xmd:gap-1 md:gap-5 justify-center items-center flex-row-reverse"
                      >
              ...
              <div className="m-auto  xmd:pb-14">
                <BtnGlobal className="  xmd:py-[10px] xmd:px-[78px] md:py-4 md:px-[108px] m-auto text-white text-center rounded-lg bg-[#4B3938]">
                  Paid
                </BtnGlobal>
              </div>
            </main>
