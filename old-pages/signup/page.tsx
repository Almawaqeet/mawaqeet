    ...
    <MbisProvider>
      ...
      <section className="max-w-[2000px] m-auto ">
        <main className="sm:grid md:grid-cols-[1fr_1fr]">
          ...
          <div
            className={`${whiteSpaces.sectionMargin}  xmd:px-5 px-[20px] sm:px-[16px] md:px-12 lg:px-[150px] xl:px-[150px] 2xl:px-[150px] xmd:pt-16 md:pt-4 xl:mt-16 lg:mt-8`}
          >
            <Headings
              type="global"
              ...
              {(props) => (
                <>
                  <Form onSubmit={props.handleSubmit}>
                    ...
                    <BtnGlobal
                      className="  xmd:py-[10px] xmd:px-[78px] md:py-4 md:px-[108px] m-auto text-white text-center rounded-lg bg-[#4B3938]"
                      type="submit"
                    >
                      Sign Up
                    </BtnGlobal>
                    ...
                    <div className="flex justify-center xmd:gap-[50px] xmd:pb-14 md:pb-7 lg:pb-[106px] xmd:pt-[26px] lg:pt-[75px]">
                      <Paragraph
                        type="global"
                        classname="text-team-clamp leading-[18px] tracking-tight font-normal text-[#848484]  "
                      >
                      ...
                      <Paragraph
                        type="global"
                        classname="text-team-clamp leading-[18px] tracking-tight font-normal text-[#87592A]  "
                      >
                        Sign In
                      </Paragraph>
                    </div>
                    ...
                    <div className=" xmd:pb-[22px] md:pb-[19px]">
                      <BtnGlobal
                        icon={
                          <FaFacebook className="text-white w-[27px] h-[27px] grid m-auto" />
                        }
                        className="bg-[#357AFF] text-fz-xss text-white text-center   xmd:w-3/4 grid m-auto rounded-lg"
                        btnStyle="justify-center xmd:gap-8 flex-row-reverse"
                      >
