  ...
  PrivatePages: {
    clientDashboard: {
      ...
      viewPackage: (packageId: string) =>
        `/client-dashboard/package/${packageId}`,
      ...
      booking: {
        ...
        initiateBooking: (packageId: string) =>
          `/client-dashboard/bookings/initiate-booking/${packageId}`,
        viewBooking: (bookingId: string) =>
          `/client-dashboard/bookings/${bookingId}`,
        initiatePayment: (bookingId: string) =>
          `/client-dashboard/bookings/${bookingId}/payment`,
      },
      wallet: {
