'use client'
import { appForm } from '@/OldPage/contents/payment';
import { whiteSpaces } from '@/OldPage/utilities/GlobalSpaces';
import ComplementNum from '@/OldPage/UI/ComplementNum';
import React from 'react';
import { MdArrowRightAlt } from 'react-icons/md';
import PaymentPage, { PaymentPageSteps } from '../components/PaymentPage';
import AppInfoContent from '@/OldPage/UI/AppInfoContent';
import Footer from '@/OldPage/UI/Footer';
import { useAppInfo } from '@/OldPage/hooks/useAppInfo';
