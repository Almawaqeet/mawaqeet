import { useAppQuery, useAppQueryWithPaginationAndParams } from "@/api/client-constructor";
import { generateBaseQueryKeyFromRoute, routes } from "@/api/routes";
import { FinancialSummaryResponse, PackageBookingFinancialSummaryResponse, PaginatedResponse, User } from "@/api/types";
...
export const useGetFinancialSummary = () => {
    const baseQueryKey = generateBaseQueryKeyFromRoute(routes.analytics.financialSummary)
...
export const useGetPackageSummaryMonthly = () => {
    const baseQueryKey = generateBaseQueryKeyFromRoute(routes.analytics.packageSummaryMonthly)
